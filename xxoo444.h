...
//#define _WORD_CHAR_H
//
//#include "meanBoardGame_Classes.h"
//#include <fstream>
//#include <iostream>
//#include <vector>
//#include <algorithm>
...
//
//template<typename T>
//Word_Char_Board<T>::~Word_Char_Board() = default;
//
//#endif //_WORD_CHAR_H
...
public:
    ...
    void getmovee(int &x, int &y, T &symbol) override;
};
...
template<typename T>
void Word_Char_Player<T>::getmovee(int &x, int &y, T &symbol) {
  cout << "\nPlease enter your move x and y (0 to 2) separated by spaces and your char: ";
  cin >> x >> y >> symbol;
}
...
template<typename T>
void Word_Char_Random_Player<T>::getmovee(int &x, int &y, T &symbol) {
  x = rand() % this->dimension;  // Random number between 0 and 2
  y = rand() % this->dimension;
  symbol = (rand() % 26) + 'A';
}
